...
// 提取服装（去除模特）的提示词
export const EXTRACT_CLOTHING_PROMPT = `请从图片中提取服装，移除模特人物，只保留服装单品。

核心要求：
1. **完全移除模特人物** - 不要保留任何人体部分（包括头部、四肢、躯干等）
2. **完整保留所有服装** - 保持服装的原始款式、颜色、材质、细节
3. **保持服装的原始形态** - 服装应该保持穿着时的自然形状和褶皱
4. **使用纯色或透明背景** - 建议使用纯白色背景或透明背景
5. **保持服装的完整性** - 确保上装、下装、鞋子等所有服装单品都完整展示

服装展示要求：
1. 服装应该以平铺或悬挂的方式展示（如商品展示图）
2. 保持服装的立体感和质感
3. 注意光影效果，确保服装细节清晰可见
4. 如果有多件服装（上装+下装+鞋子），可以分别展示或组合展示
