...
1. **绝对不要改变模特的身材比例** - 模特的身材必须与原图完全一致：
   ...
   - ❗**身体其他部位也要保持** - 胸部、腰部、臀部、手臂等所有身材特征都不能改变
...
- ❌ 不要为了"显瘦"、"显高"、"拉长比例"而修改腿部身材
- ❌ 不要改变其他任何身体部位的尺寸和比例

✅ 正确做法：
- ✅ 只改变姿势（腿的摆放角度、站姿、动作），绝对不改变身材（腿的长短、粗细）
- ✅ 姿势适应原有身材，而不是身材适应姿势
- ✅ 保持原图模特真实的身材比例，展现真实的姿态效果

请生成一张符合上述要求的模特图片，特别注意：在展现腿部动作自然优雅的同时，必须完全保持原图中腿部的长度、粗细和形状不变。`;
