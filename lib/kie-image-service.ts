...
1. **眼神和面部朝向（最高优先级）**：
   ...
   - ❗**保持专业模特的镜头感，眼神要有神、自信、自然**
   - ❗**即使是低头或侧身的姿势，眼神也应该看向镜头方向，而不是看地面**
...
1. **模特的眼神必须看向镜头或略微偏向一侧，绝对不要朝地上看、朝下看** - 这是最高优先级要求
2. **在展现背面姿势时，臀部的大小、形状、曲线必须与原图完全一致**
3. 在展现腿部动作自然优雅的同时，必须完全保持原图中腿部的长度、粗细和形状不变
4. 所有身材特征（臀部、腿部、腰部等）都必须与原图100%一致，只改变姿势角度`;
